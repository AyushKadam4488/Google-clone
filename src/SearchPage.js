        ...
        <div className='searchPage_headerBody'>
          ...
          <div className='searchPage_options'>
            <div className='searchPage_optionsLeft'>
              ...
              <div className='searchPage_option'>
                <LocalOfferIcon />
                <Link to="/shopping">Shoopping</Link>
              </div>
              <div className='searchPage_option'>
                <RoomIcon />
            ...
            <div className='searchPage_result'>
              <a
               className='searchPage_resultLink' href={item.link}>
                {item.pagemap?.cse_image?.length > 0 && item.pegemap?.cse_image[0]?.src && (
                  <img className='searchPage_resultImage'
                  src={item.pagemap?.length > 0 && item.pagemap?.cse_image[0]?.src}
                  alt='' />
                )}
